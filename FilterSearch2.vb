...
Public Class FilterSearch2
    Dim cmd As MySqlCommand
    Dim adapter As MySqlDataAdapter
    Dim table As DataTable
    Dim query As String
    Private mainForm As EnrollTab

    Public Sub New(form As EnrollTab)
        InitializeComponent()
        mainForm = form
    End Sub
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Try
            conn.Open()
            mainForm.dgvGetStudent.Rows.Clear()
            ...
            Using cmd As New MySqlCommand(query, conn)
                ...
                Using dr = cmd.ExecuteReader
                    While dr.Read
                        ...
                        mainForm.dgvGetStudent.Rows.Add(acceptImage, dr("studentID"), dr("firstname"), dr("lastname"), dr("middle"), dr("extensionName"), dr("gender"),
            ...
            mainForm.dgvGetStudent.ClearSelection()
